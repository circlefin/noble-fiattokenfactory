...
replace (
	...
	// use strangelove-ventures/interchaintest/v4 hot-fix
	github.com/strangelove-ventures/interchaintest/v4 => github.com/noble-assets/interchaintest/v4 v4.0.0-20231026104200-eb0d0c054327
